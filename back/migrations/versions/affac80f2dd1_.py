...
Revision ID: affac80f2dd1
Revises: f7db7c7a8e3d
Create Date: 2025-09-26 22:09:04.921522
...
revision: str = 'affac80f2dd1'
down_revision: Union[str, Sequence[str], None] = 'f7db7c7a8e3d'
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('client_company_id')
    )
